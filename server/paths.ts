...
export const runtimeDirectories = ['config', 'profiles/pc', 'profiles/switch', 'profiles/exception', 'thumbnails', 'media/bgm', 'descriptions', 'logs', 'backups', 'database'] as const
