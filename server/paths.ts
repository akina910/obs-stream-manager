...
export const runtimeDirectories = ['config', 'profiles/pc', 'profiles/switch', 'profiles/exception', 'thumbnails', 'media/bgm', 'templates/common/rendered', 'descriptions', 'logs', 'backups', 'database'] as const
